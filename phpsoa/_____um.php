...
*/
$api_request_url = 'http://leonbsilva.ddns.net:8080/projects/10/canvas_projects/14/canvas_tickets.json?key=1708de85ebd115e4ab7c79824cdbdc849c79f6e9';
...
#  'user_id' => 5428,
#  'data' => '{"text":"filipe","canvas_box_id":"1","canvas_project_id":8}'
#);

$api_request_parameters = array(
	'key'=>'1708de85ebd115e4ab7c79824cdbdc849c79f6e9'
);
...
// Response Body
var_dump(json_decode($api_response_body,true));
